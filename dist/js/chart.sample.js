...
var ctx2 = document.getElementById('satisfaction-bar-chart').getContext('2d');
// const ctx3 = document.getElementById('doughnut-chart').getContext('2d');

var labels2 = ["Hombre", "Mujer"];
var data2 = {
  labels: labels2,
  datasets: [{
    label: 'Satisfacción',
    data: [7, 5, 3],
    backgroundColor: ['rgba(153, 102, 255, 0.2)', 'rgb(255, 205, 86, 0.2)'],
    borderColor: ['rgb(153, 102, 255)', 'rgb(255, 205, 86)'],
    borderWidth: 1
  }]
};
